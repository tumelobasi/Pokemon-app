...
const getPokemon = async () => {
  try {
    // Get Pokémon name or ID from the search input
    ...
    // Reset display and show alert if Pokémon not found
    resetDisplay();
    alert("Pokémon not found");
  }
};

// Function to reset the Pokémon display
const resetDisplay = () => {
  const sprite = document.getElementById("sprite");
  if (sprite) sprite.remove();

  // Reset Stats and Information
